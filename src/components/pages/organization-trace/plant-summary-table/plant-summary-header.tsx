...
import { plantSummaryColumns } from '@/enum-data/organization-trace/org-trace-index';
import { getTranslatedValue } from '@/helpers/get-translated-value';
import { PlantSummaryTableHeaderProps } from '@/types/pages/organization-trace';
import { useState } from 'react';

export const PlantSummaryHeader = ({
  ...
  const columns = plantSummaryColumns(
    () => { },
    () => { },
  );
  ...
  return (
    <div className="plant-summary-header">
      <span>{getTranslatedValue('re_plant_summary')}</span>
      <DropdownWrapper
