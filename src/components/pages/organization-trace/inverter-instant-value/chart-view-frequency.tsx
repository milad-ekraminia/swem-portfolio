  ...
  return (
    <div className="device-inverter-charts-container-grid__item">
      <LineChart
        series={series}
        dates={uniqueDates}
        title={getTranslatedValue(`FrequencyGraph`)}
        isLoading={isLoading}
...
const ChartViewFrequency = memo(MemoChartViewFrequency);

export default ChartViewFrequency;
