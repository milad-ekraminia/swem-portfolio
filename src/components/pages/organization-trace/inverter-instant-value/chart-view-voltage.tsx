  ...
  return (
    <div className="device-inverter-charts-container-grid__item">
      <LineChart
        series={series}
        dates={uniqueDates}
        title={getTranslatedValue(`VoltageGraph`)}
        isLoading={isLoading}
        chartId="voltage-chart"
...
const ChartViewVoltage = memo(MemoChartViewVoltage);

export default ChartViewVoltage;
