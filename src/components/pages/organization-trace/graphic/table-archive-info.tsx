import { MailBoxSvg } from '@/assets/icons/mail-box-svg';
...
const MemoArchiveInfo = ({
  ...
  const { fields, append, remove } = useFieldArray<{
    deviceArchiveFields: any[];
  }>({
    control,
    name: 'deviceArchiveFields',
  });
...
const ArchiveInfo = memo(MemoArchiveInfo);
