...
import { getEnergyIndexReportApi } from '@/services/reports/get-reports-apis';
import { BreadcrumbItem } from '@/types/components/ui/bread-crumb';
import { reportsAddProfileInitialValuesTypes } from '@/types/pages/reports/reports';
import { reportsAddProfileEnergyIndexInitialValues } from '@/validations/reports/reports-validation';
...
const baseBreadcrumbs: BreadcrumbItem[] = [
  ...
  {
    label: 'em_report_energy_index_value',
  },
];
...
export default function EnergyIndexReports() {
  ...
  const {
    ...
    defaultValues:
      reportsAddProfileEnergyIndexInitialValues as reportsAddProfileInitialValuesTypes,
    context: {
  ...
  const {
    ...
    queryKey: ['Energy Index Report', currentPage, sortData, pageSize],
    queryFn: () => getEnergyIndexReportApi({
      dataParams: {
  ...
  const staticTableHeaders: any[] = useMemo(
    () => [
      ...
      {
        title: 'EnergyTotalRawIndexValue',
        accessorKey: 'energyTotalRawIndexValue',
        sort: 'EnergyTotalRawIndexValue',
      },
      {
        title: 'FMIndex',
        accessorKey: 'energyTotalIndexValue',
        sort: 'FMIndex',
      },
      {
        title: 'unit',
      ...
      <div className="page-wrapper__body">
        <div className="reports">
          <div className="reports-form">
            <ReportsFormWrapper
              title={getTranslatedValue('em_report_energy_index_value')}
              setValue={setValue}
              ...
              control={control}
              hasPeriodType={false}
              filterName="device-energy-index-values"
              errors={errors}
            ...
            <div className="reports-response">
              <ReportResults
                ...
                excelParams={{
                  ...
                  excelUrl: `app/export-to-excel/export-to-excel-device-energy-index-values-list?api-version=${import.meta.env.VITE_API_VERSION}`,
                }}
                chartType="area"
                hasTab={false}
              />
